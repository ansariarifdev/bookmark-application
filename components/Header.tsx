        ...
        <div className="hidden items-center gap-2 md:flex">
          ...
          {!user ? (
            <Button
              asChild
              size="sm"
              className="bg-linear-to-r from-primary to-primary/80 transition-opacity hover:opacity-90"
            >
          ...
          <div className="absolute left-0 right-0 top-16 border-b border-border/60 bg-background/95 px-4 py-4 shadow-md backdrop-blur supports-backdrop-filter:bg-background/70">
            <div className="mx-auto flex max-w-6xl flex-col gap-2">
              ...
              {!user ? (
                <Button
                  asChild
                  className="justify-start bg-linear-to-r from-primary to-primary/80"
                >
                  <Link href="/auth/signin" className="flex items-center gap-2">
                    <LogIn className="h-4 w-4" />
                    Sign in with Google
